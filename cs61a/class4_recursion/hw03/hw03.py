...
def digit_distance(n):
    ...
    n1,n2=n%10,n%100//10
    if n1>n2:
        return digit_distance(n//10)+(n1-n2)
    else:
        return digit_distance(n//10)+(n2-n1)
...
def interleaved_sum(n, f_odd, f_even):
    ...
    """
    "*** YOUR CODE HERE ***"
    def add(k,n,f_odd,f_even):
       if k<n: 
           return add(k+2,n,f_odd,f_even)+f_odd(k)+f_even(k+1)
       elif k>n:
           return 0
       else:
            return f_odd(k)
    return add(1,n,f_odd,f_even) 
...
def count_dollars(total):
    ...
    def partition(total,num):
        ...
        with_num=partition(total-num,num)
        without_num=partition(total,next_smaller_dollar(num))
