...
def sus_points(score):
    ...
    "*** YOUR CODE HERE ***"
    # END PROBLEM 4
    number=num_factors(score)
    if number==3 or number==4:
        score+=1
        while not isprime(score):
            score+=1
        return score
    else:
        return score
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    while score0<goal and score1<goal:
        if who==0:
            number=strategy0(score0,score1)
            score0=sus_update(number,score0,score1,dice)
        else:
            number=strategy1(score1,score0)
            score1=sus_update(number,score1,score0,dice)
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    give=boar_brawl(score, opponent_score)
    if give>=threshold:
        return 0
    else:
        return num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    if sus_update(0, score, opponent_score, dice)-score>=threhold:
        return 0
